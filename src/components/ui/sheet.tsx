...
const sheetVariants = cva(
  "tailwind.config.jsfixed tailwind.config.jsz-50 tailwind.config.jsgap-4 tailwind.config.jsbg-white tailwind.config.jsp-6 tailwind.config.jsshadow-lg tailwind.config.jstransition tailwind.config.jsease-in-out data-[state=open]:tailwind.config.jsanimate-in data-[state=closed]:tailwind.config.jsanimate-out data-[state=closed]:tailwind.config.jsduration-300 data-[state=open]:tailwind.config.jsduration-500 dark:tailwind.config.jsbg-neutral-950",
  {
    variants: {
      side: {
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="tailwind.config.jsabsolute tailwind.config.jsright-4 tailwind.config.jstop-4 tailwind.config.jsrounded-sm tailwind.config.jsopacity-70 tailwind.config.jsring-offset-white tailwind.config.jstransition-opacity hover:tailwind.config.jsopacity-100 focus:tailwind.config.jsoutline-none focus:tailwind.config.jsring-2 focus:tailwind.config.jsring-neutral-950 focus:tailwind.config.jsring-offset-2 disabled:tailwind.config.jspointer-events-none data-[state=open]:tailwind.config.jsbg-neutral-100 dark:tailwind.config.jsring-offset-neutral-950 dark:focus:tailwind.config.jsring-neutral-300 dark:data-[state=open]:tailwind.config.jsbg-neutral-800">
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("tailwind.config.jstext-lg tailwind.config.jsfont-semibold tailwind.config.jstext-neutral-950 dark:tailwind.config.jstext-neutral-50", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn("tailwind.config.jstext-sm tailwind.config.jstext-neutral-500 dark:tailwind.config.jstext-neutral-400", className)}
    {...props}
  />
))
